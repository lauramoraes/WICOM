...
<script>
	...
	function getCorrectString(form)
	{
		...
		if(endDate!=0 && startDate!=0)
			...
			{
				alert("The end date must come after the start one.")
				 return false;
			}
...
<input type="checkbox" id="check4" value="4" onClick="javascript:functionSelect('4')"><span id="text4"> Select all </span>
	...
	<form name="selectModules" id="selectModules" method="get" action="./wicomViewStatusCommentTimeline.php" onsubmit="return getCorrectString(selectModules);">
